              ...
              <tbody>
                <tr v-for="t in transactions" :key="t.id">
                  ...
                  <td style="color:var(--text-muted);font-size:0.8rem;white-space:nowrap;">
                    <i class="bi bi-calendar3 me-1 d-none d-sm-inline"></i>{{ t.date }}
                  </td>
                  ...
                  <td class="d-none d-sm-table-cell" style="color:var(--text-secondary);font-size:0.875rem;">
                    {{ t.description || '—' }}
                  </td>
                  ...
                  <td class="text-end" style="white-space:nowrap;">
                    ...
                    <button
                      @click="destroy(t.id)"
                      style="background:rgba(244,67,54,0.1);color:#ef5350;border:1px solid rgba(244,67,54,0.3);border-radius:8px;padding:3px 8px;font-size:0.75rem;cursor:pointer;transition:all 0.2s;"
                    >
